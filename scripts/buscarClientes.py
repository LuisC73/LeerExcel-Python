...
try:
    ...
    def agregar_filtros(df):
        clientes = ["99990239","8488975","47481589","4774565","87042441"]
        print("Buscando clientes")
        df = df[df["NUMERO_DE_CUENTA"].isin(clientes)]
        print(df)
        print("Clientes Encontrados con exito")
            # elif buscar == 2:    
    ...
    def exportar_datos(df):
        ...
        import os
        path = r"D:\Users\practicante.geserv1\OneDrive - Centro de Servicios Mundial SAS\Imágenes\lm\Python\BuscarArray-Python\output\."
